...
- Cola: `02-docs/02_3-engineering/implementation-queue-mvp.json` — 34/34 tasks `done`
- Estado: `02-docs/02_1-product/user-stories/status-v1.json` — 10/10 historias MVP `done`
