...
Single source of truth for **implementation** practices. Product and architecture docs live in `02-docs/02_1-product/` and `02-docs/02_2-architecture/`. Governs code in `src/` and tests in `tests/`.
...
5. **Language** — English: code, comments, commits, OpenSpec artifacts. Spanish: product documentation in `02-docs/02_1-product/`.
...
|-------|----------|--------------|
| Static context | `01-knowledge/` | Domain terms, templates |
| Living docs | `02-docs/02_1-product/`, `02-docs/02_2-architecture/` | PRD, HLD, LLD, user stories |
| Engineering standards | `02-docs/02_3-engineering/standards/` | Before every implementation task |
...
| Testing | `.cursor/rules/05-testing-rules.mdc`, `02-docs/02_4-qa/test-strategy.md` |
...
3. Read task detail in `02-docs/02_1-product/user-stories/US-NNN.md` §Detalle por task.
...
- Plan: `02-docs/02_3-engineering/implementation-plan-mvp.md`
