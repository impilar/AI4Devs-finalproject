...
**Versión:** 1.0  
**Fuente:** `02-docs/02_2-architecture/hld/HLD-v1.md`, `02-docs/02_1-product/prd/PRD-v1.md`  
...
*Generado con el agente Data Model Generator a partir de `02-docs/02_2-architecture/hld/HLD-v1.md` y `01-knowledge/templates/architecture/data-model-template.md`.*
