...
1. **Derivar de la arquitectura:** Usar entidades, relaciones e índices definidos en `HLD-v1.md`; no contradecir el stack (PostgreSQL + Prisma).
...
9. **No incluir esta sección** en el documento de salida (`logical-model-v1.md`).
