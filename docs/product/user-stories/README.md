...
Plantilla vacía para nuevas historias: [`knowledge/templates/product/user-story_template.md`](../../../knowledge/templates/product/user-story_template.md).

Secciones de enriquecimiento técnico (post-LLD): [`knowledge/templates/product/user-story-enriched_sections.md`](../../../knowledge/templates/product/user-story-enriched_sections.md).  
