...
**Versión:** 1.0  
**Fuente:** `docs/architecture/hld/HLD-v1.md`, `docs/product/prd/PRD-v1.md`  
...
*Generado con el agente Data Model Generator a partir de `docs/architecture/hld/HLD-v1.md` y `knowledge/templates/architecture/data-model-template.md`.*
