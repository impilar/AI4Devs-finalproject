...
**References:** [US-002](docs/product/user-stories/US-002.md), [implementation-plan-v1.md §PHASE-002](docs/engineering/implementation-plan-v1.md), PRD RF-004/RF-016, LLD-v1 §4.2, §5, §7.1, §8.1, §9.2.
