...
Vista estática del dominio del Organizador de Conocimiento. Para el modelo lógico/físico versionado, ver [`02-docs/02_2-architecture/data-model/`](../02-docs/02_2-architecture/data-model/).
